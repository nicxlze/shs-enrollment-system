...
<div class="container">
    <section class="form-section">
        ...
        <form action="success.php" method="POST"> <!-- Changed action to "details.php" -->
            <table>
                <tr>
    ...
    <tr>
        <td style="border: 1px solid black;">Grade 11</td>
        <td style="border: 1px solid black;">34,452</td>
        <td style="border: 1px solid black;">14,494</td>
        <td style="border: 1px solid black;"></td>
        <td style="border: 1px solid black;">48,946</td>
        <td style="border: 1px solid black;">14,000</td>
        <td style="border: 1px solid black;"><label>34,946</label></td>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="border: 1px solid black;">Grade 11</td>
        <td style="border: 1px solid black;">Semi-Annual  </td>
        <td style="border: 1px solid black;">24,623</td>
        <td style="border: 1px solid black;">24,623</td>
